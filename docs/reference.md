...
The public API lives at the module root (`github.com/go-ruby-shrine/shrine`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `shrine`, while the surface follows
...
```go
import "github.com/go-ruby-shrine/shrine"
```
...
- **[pkg.go.dev/github.com/go-ruby-shrine/shrine](https://pkg.go.dev/github.com/go-ruby-shrine/shrine)**

The module's [README](https://github.com/go-ruby-shrine/shrine#readme) carries worked
