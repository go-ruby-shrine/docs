...
Contributions are welcome. `go-ruby-shrine/shrine` is built to a small set of
...
The library is in [`github.com/go-ruby-shrine/shrine`](https://github.com/go-ruby-shrine/shrine).
This documentation site is in [`github.com/go-ruby-shrine/docs`](https://github.com/go-ruby-shrine/docs).
