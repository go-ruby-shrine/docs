# go-ruby-shrine documentation

**Pure-Go Shrine: file attachment toolkit (storages/uploaders/attacher), CGO=0 — bound into rbgo**

`go-ruby-shrine/shrine` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `shrine`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `shrine`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`shrine`](https://github.com/go-ruby-shrine/shrine) | the library — Ruby's `shrine` in pure Go |
| [`docs`](https://github.com/go-ruby-shrine/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-shrine.github.io`](https://github.com/go-ruby-shrine/go-ruby-shrine.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-shrine/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-shrine/shrine](https://github.com/go-ruby-shrine/shrine).
